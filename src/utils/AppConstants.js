...
export const Preview_Values = [
    ...
    { src: `${imageFortyFive}`, classes: "img img-lg-ctr", publishDate: "16.08.2021", altText: "Marquage du sentier vers Hovlandsnuten", id: "7", blogEntry: "J'ai récemment commencé à travailler avec la Sauda Ferie og Fritid et c'est vraiment sympa. Mon « travail » consiste à faire de la randonnée, à boire du café et à manger des myrtilles. De temps en temps, je peins des trucs.", writtenBy:"Alan" },
    { src: `${imageFortySeven}`, classes: "img img-lg-ctr", publishDate: "14.08.2021", altText: "Jonestølen", id: "8", blogEntry: "Je suis venu ici pour mon premier projet avec Ferie og Fritid et j'ai tout de suite su que j’y passerais beaucoup de temps. Une cascade tombe à travers les collines, abreuvant les myrtilliers et remplissant un lac d’eau cristalline dans la vallée en contrebas.", writtenBy:"Alan" },
];
...
export const Blogpost_Values = [
  ...
  { src: `${imageTwentySeven}`, classes: "img img-lg-ctr", id: "21", previewValue: "2"},
    ...
    { src: `${imageFortyFour}`, classes: "img img-lg-ctr", id: "37", previewValue: "5"},
     ...
     // Preview 7
    { src: `${imageFortySix}`, classes: "img img-lg-ctr", id: "38", blogEntry: "Depuis notre arrivée en Norvège, nous avons exploré les environs autant que possible. J'ai pensé qu'il pourrait être utile de travailler sur les sentiers pour mieux connaître la région. J'avais raison. J’ai joint une groupe de volontaires qui s’occupe de la maintenance des chemins de randonnée. Depuis le début de mes travaux sur les sentiers il y a quelques semaines, nous avons découvert des zones incroyables. Jusqu'à présent, le meilleur est Jonestølen, que je détaillerai dans un autre article. C'était le premier endroit où j'ai fait de la randonnée avec Leif qui travaille sur les sentiers depuis environ 15 ans. Nous partons tous les deux généralement chaque semaine pour construire des sentiers, peindre des balises ou installer des panneaux. J'ai toujours voulu travailler sur les systèmes de sentiers, et je ne peux pas penser à un meilleur endroit pour commencer que la Norvège.", previewValue: "7"},

    // Preview 8
    { src: `${imageFortySeven}`, classes: "img img-lg-ctr", id: "39", blogEntry: "Nous sommes venus ici un samedi pour nous éloigner de l'agitation de Sauda (…). La randonnée dure un peu moins de deux heures et serpente à travers les arbres, les fleurs et les myrtilles jusqu'à se terminer à la cabine. Nous avons eu une pluie légère en montant, assez pour tremper mon pantalon. Heureusement, il y avait une couverture en laine que j'ai enroule autour de ma taille à l'intérieur de la cabine.", previewValue: "8"},
    { src: `${imageFortyEight}`, classes: "img img-lg-ctr", id: "40", blogEntry: "Peu de temps après notre arrivée, Camille était à pied d'œuvre pour cueillir des myrtilles. Après quelques heures, il a commencé à pleuvoir ; Camille a néanmoins continué la cueillette. Quand elle en a eu finalement terminé, nous en avions récolté tellement que nous avions dû congeler quelques sacs au retour.", previewValue: "8"},
    { src: `${imageFortyNine}`, classes: "img img-lg-ctr", id: "41", blogEntry: "La regarder travailler m’a épuisé, alors j'ai décidé de faire un plongeon dans le lac en contrebas. Il faisait froid, mais savoir que le feu dans le poêle à bois m’attendait dans l'hytta m'a facilité un peu la tâche.", previewValue: "8"},
]